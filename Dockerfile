...
RUN SOURCEBASE_FLUTTER_ANON_KEY="${SOURCEBASE_SUPABASE_ANON_KEY:-$SOURCEBASE_SUPABASE_PUBLIC_TOKEN}" && \
  flutter build web --release \
  --dart-define=SOURCEBASE_SUPABASE_URL="${SOURCEBASE_SUPABASE_URL}" \
  --dart-define=SOURCEBASE_SUPABASE_ANON_KEY="${SOURCEBASE_FLUTTER_ANON_KEY}" \
  --dart-define=SOURCEBASE_SUPABASE_PUBLIC_TOKEN="${SOURCEBASE_FLUTTER_ANON_KEY}" \
